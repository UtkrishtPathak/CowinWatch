...
module.exports =
{
    execute(message,args,Discord)
    {
        ...
        axios
        .get(`https://cdn-api.co-vin.in/api/v2/appointment/sessions/public/calendarByPin?pincode=${args[0]}&date=${ind_time}`,
        ...
        {
            var centres=response.data.centers;  //storing the centres data
            ...
            centres.forEach((centre) =>
            {
                ...
                {
                    slots_embed.execute_pin(message,centre,ind_time,Discord);
